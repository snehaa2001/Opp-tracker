      ...
      <div className="relative flex flex-col gap-6 p-6">
        ...
        <div className="space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  placeholder="0"
                  min="0"
                  aria-invalid={!isCeilingValid}
                  aria-describedby={!isCeilingValid ? 'ceiling-error' : undefined}
                  className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
                />
              </div>
              <div className="space-y-1.5">
            ...
            {!isCeilingValid && (
              <p id="ceiling-error" role="alert" className="rounded-lg bg-red-50 px-3 py-2 text-xs text-red-600 dark:bg-red-900/30 dark:text-red-300">Min must be less than or equal to max</p>
            )}
          </section>
